...
export const projects: Project[] = [
  ...
  {
    id: 'merav-arditi',
    title: { he: 'מירב ארדיטי', en: 'Merav Arditi' },
    description: {
  ...
  },
  {
    ...
    description: {
      he: 'אפליקציית לוח שנה מבוססת AI עם קלט קולי (Gemini + Deepgram), בנויה על Next.js ו-Supabase. בפיתוח פעיל.',
      en: 'AI-powered calendar app with voice input (Gemini + Deepgram), built on Next.js + Supabase. In active development.',
    },
